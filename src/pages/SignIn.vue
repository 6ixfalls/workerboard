<template>
    <main id="content" role="main" class="w-full max-w-md mx-auto p-6">
        ...
        >
            <a
                class="pr-3.5 inline-flex items-center gap-x-2 text-sm text-gray-600 decoration-2 dark:text-gray-500 hover:underline hover:text-blue-600 dark:hover:text-gray-200 transition"
            ...
            <a
                class="pl-3.5 inline-flex items-center gap-x-2 text-sm text-gray-600 decoration-2 dark:text-gray-500 hover:underline hover:text-blue-600 dark:hover:text-gray-200 transition"
